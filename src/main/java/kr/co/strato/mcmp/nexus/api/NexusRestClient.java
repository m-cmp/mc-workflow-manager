...
public class NexusRestClient {
    ...
    public HttpHeaders getHeaderByPassword(Oss nexus) throws Exception {
    	...
    	String encodedValue = Base64Utils.base64Encoding(value);
    ...
    public <T, U> Object request(Oss nexus, String apiUri, HttpMethod httpMethod, U body, Class<T> clazz)  {
    	T responseBody = null;
