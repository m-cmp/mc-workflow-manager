package m.cmp.wfManager.jenkins.controller;
...
import m.cmp.wfManager.jenkins.service.JenkinsPipelineService;

@Tag(name = "JenkinsPipeline", description ="젠킨스 스테이지 관리")
@RestController
public class JenkinsPipelineController {
    ...
    @PostMapping("/jenkins/pipeline/list")
    ...
    @GetMapping("/jenkins/pipeline/{pipelineId}")
    ...
    @GetMapping("/jenkins/pipeline/default")
    ...
    @GetMapping("/jenkins/pipeline/name/duplicate")
    ...
    @PutMapping("/jenkins/pipeline/{pipelineId}")
    ...
    @DeleteMapping("/jenkins/pipeline/{pipelineId}")
