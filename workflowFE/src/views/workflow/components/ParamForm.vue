...
const advancedParamKeys = [
  ...
  'K8S_NODEGROUP_CREATE_IF_MISSING',
  'K8S_STATUS_MAX_ATTEMPTS',
  'K8S_STATUS_INTERVAL_SECONDS',
  'K8S_READY_STATUS',
  'K8S_KUBECONFIG_MAX_ATTEMPTS',
  'K8S_KUBECONFIG_INTERVAL_SECONDS',
  'K8S_API_READY_MAX_ATTEMPTS',
  'K8S_API_READY_INTERVAL_SECONDS',
  'K8S_NODE_READY_MIN_COUNT',
  'ROLLOUT_TIMEOUT',
]
const sectionDefinitions = [
  ...
  },
  {
    ...
    keys: [
      ...
      'HELM_CHART',
      'HELM_CHART_VERSION',
      'HELM_RECREATE_ON_IMMUTABLE_ERROR',
      'HELM_VALUES_ARGS',
    ],
  },
  {
...
const paramLabels: Record<string, string> = {
  ...
  INFRA_PREFIX: 'Infra Prefix',
  INFRA_NODEGROUP_NAME: 'Node Group',
  INFRA_NODEGROUP_PREFIX: 'Node Group Prefix',
  SSH_HOST: 'SSH Host',
  SSH_USER: 'SSH User',
  ...
  K8S_API_READY_MAX_ATTEMPTS: 'API Ready Attempts',
  K8S_API_READY_INTERVAL_SECONDS: 'API Ready Interval',
  K8S_NODE_READY_MIN_COUNT: 'Ready Node Count',
  K8S_STATUS_MAX_ATTEMPTS: 'Cluster Status Attempts',
  K8S_STATUS_INTERVAL_SECONDS: 'Cluster Status Interval',
  K8S_READY_STATUS: 'Cluster Ready Status',
  K8S_KUBECONFIG_MAX_ATTEMPTS: 'Kubeconfig Attempts',
  K8S_KUBECONFIG_INTERVAL_SECONDS: 'Kubeconfig Interval',
  ...
  HELM_RECREATE_ON_IMMUTABLE_ERROR: 'Recreate on Immutable Error',
...
const paramHints: Record<string, string> = {
  ...
  INFRA_NODEGROUP_PREFIX: 'Used to create CSP-specific node group names, such as ng-aws.',
