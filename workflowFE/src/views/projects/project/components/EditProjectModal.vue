<template>
  <div class="modal fade" id="modalProjectEdit" aria-hidden="true" tabindex="-1">
            ...
            <div class="modal-body">
              ...
              <div class="fs-6 text-gray-800 fw-bold me-5 projectTop">
                ...
                <el-form-item prop="projectName" class="d-flex projectTop_projectName">
                  ...
                  <el-input
                    v-model.trim="state.editData.projectName"
...
import { checkProjectConnection, getProjectDuplicate, setProject, updateProject } from "@/api/projects";
...
export default defineComponent({
  ...
  setup(props, {emit}) {
      ...
      function invoke(project) {
        (instance?.refs.editForm as any).clearValidate();
        init(project)
      }
      ...
      function init(project) {
        state.value.editData = {
          ...
          projectPackage: project.packageName,
          gitlabUrl: project.gitlabCloneHttpUrl,
          gitlabUserName: project.gitlab.username,
          gitlabPassWord: project.gitlab.password,
          // ossToken: '',
          gitlabBranch: project.gitlab.branch,
        };
      ...
      async function executeTestConnection() {
        try {
          ...
          if(state.value.isNewPassword == true) {
            state.value.editData.gitlabPassWord = btoa(state.value.editData.gitlabPassWord)
          }
          ...
          let params = {
            ...
            gitlab : {
              ...
              password: editData.gitlabPassWord
            }
          }
      ...
      async function submitForm() {
        ...
        try {          
          ...
          const response:any = await updateProject(params);
      ...
      function focusOnPassword() {
        state.value.isNewPassword = true
        state.value.editData.gitlabPassWord = ''
        state.value.isConnectChecked = false
      }
