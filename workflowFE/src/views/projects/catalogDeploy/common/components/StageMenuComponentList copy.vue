<template>
	<div>
		...
		<!-- 클러스터 목록 -->
		<div v-if="state.editData.providerCd" class="mb-5" style="margin-top: 50px;">
			<span class="field-label required">
	...
	<yaml-modal ref="yamlModal"></yaml-modal>
	</div>
</template>
<script lang="ts">
...
export default {
    ...
    const { t } = useI18n();
		...
		async function clickedProvider() {
			const params = {
