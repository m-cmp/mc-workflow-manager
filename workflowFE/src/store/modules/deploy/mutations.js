...
export const SET_PASS_K8S_ID = "setPassK8sId"
export const ADD_INFO_ITEM = "addInfoItem";

export const SET_NEXUS_REPOSITORY_LIST = "setNexusRepositoryList";
...
//////////////////////
export const SET_WORKFLOW_DEPLOY_EDIT_DATA = "setWorkflowDeployEditData";
...
export default {
	...
	[SET_DEPLOY_CONFIG_COUNTS]:(state, deployConfigCounts)=>{
		state.deployConfigCounts = deployConfigCounts;
	},
	...
	[SET_PASS_K8S_ID]:(state, passK8sId)=>{
		state.passK8sId = passK8sId;
	},
	...
	[SET_DEPLOY_TYPE_INFO]: (state, typeInfo)=>{
		...
		state.deployCd = typeInfo.deployCd;
	...
	////////////////////////////////////////////////////////
	[SET_NEXUS_REPOSITORY_LIST]: (state, nexusRepositoryList) => {
		state.nexusRepositoryList = nexusRepositoryList
	},
	...
	////////////////////////////////////////////////////////
	[SET_WORKFLOW_DEPLOY_EDIT_DATA]: (state, editData) => {
