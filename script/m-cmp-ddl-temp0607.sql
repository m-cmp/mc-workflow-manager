...
--
-- Host: 10.10.30.28    Database: m-cmp
-- ------------------------------------------------------
-- Server version	5.5.5-10.10.4-MariaDB
...
--
-- Table structure for table `argocd_app`
--
...
--
-- Dumping data for table `argocd_app`
--
...
--
-- Dumping data for table `catalog_deploy`
--
...
--
-- Dumping data for table `catalog_deploy_history`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='빌드_젠킨스 파이프라인';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `jenkins_pipeline`
--
...
CREATE TABLE `oss` (
  ...
  `mod_date` datetime DEFAULT NULL COMMENT '수정일시',
  PRIMARY KEY (`oss_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='설정_oss 접속 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sw_catalog` (
  ...
  `sc_category` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `sw_catalog`
--
...
--
-- Dumping data for table `sw_catalog_relation_catalog`
--
...
--
-- Dumping data for table `sw_catalog_relation_workflow`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='배포_k8s 배포 이력 정보';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=224 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='배포 젠킨스 파이프라인 매핑';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `workflow_jenkins_pipeline_mapping`
--
--
...
--
-- Dumping data for table `workflow_new`
--
...
CREATE TABLE `workflow_v2` (
  ...
  PRIMARY KEY (`workflow_id`),
  KEY `fk_deploy_idx2` (`jenkins_id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='워크플로우_정보';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `workflow_v2`
--

--
-- Dumping routines for database 'm-cmp'
--
...
-- Dump completed on 2024-06-07 13:40:31
